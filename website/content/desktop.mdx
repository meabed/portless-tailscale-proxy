...
<div className="dl-grid">
  <a className="dl-btn" href="https://github.com/meabed/tailscale-proxy/releases/latest/download/Tailscale-Proxy-Apple-Silicon.dmg">
    ...
    <span><b>macOS</b> — Apple Silicon<span>.dmg</span></span>
  </a>
  <a className="dl-btn" href="https://github.com/meabed/tailscale-proxy/releases/latest/download/Tailscale-Proxy-Intel.dmg">
    <svg viewBox="0 0 24 24" fill="currentColor"><path d="M16.4 12.8c0-2.2 1.8-3.3 1.9-3.3-1-1.5-2.6-1.7-3.2-1.7-1.4-.1-2.6.8-3.3.8s-1.7-.8-2.9-.8c-1.5 0-2.9.9-3.6 2.2-1.6 2.7-.4 6.7 1.1 8.9.7 1.1 1.6 2.3 2.7 2.2 1.1 0 1.5-.7 2.8-.7s1.6.7 2.8.7c1.2 0 1.9-1.1 2.6-2.1.8-1.2 1.2-2.4 1.2-2.4s-2.3-.9-2.4-3.7zM14.3 5.9c.6-.7 1-1.7.9-2.7-.9 0-1.9.6-2.5 1.3-.6.6-1 1.6-.9 2.6 1 .1 2-.5 2.5-1.2z"/></svg>
    <span><b>macOS</b> — Intel<span>.dmg</span></span>
  </a>
  <a className="dl-btn" href="https://github.com/meabed/tailscale-proxy/releases/latest/download/Tailscale-Proxy-Windows.zip">
  ...
  <a className="dl-btn" href="https://github.com/meabed/tailscale-proxy/releases/latest/download/Tailscale-Proxy-Linux.tar.gz">
...
**macOS** — open the `.dmg` and drag **Tailscale Proxy** to Applications. It's not yet notarized, so the first launch needs one of:
...
```bash
tar xzf TailscaleProxy-*-linux-amd64.tar.gz
sudo apt install libgtk-3-0 libwebkit2gtk-4.1-0   # runtime deps
./tailscale-proxy
```
