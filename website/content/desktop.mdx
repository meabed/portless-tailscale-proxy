...
<div className="dl-grid">
  <a className="dl-btn" href="https://github.com/meabed/tailscale-proxy/releases">
...
Each button opens the **Releases** page — pick the newest **`desktop-v…`** release and download your platform's file.
